...
def upload_info():
    global upload_info
    upload_info = Toplevel(main_window)
    upload_info.title("Upload info menu")
    upload_info.geometry("1000x700")
    upload_info.configure(background='white')
    Label(upload_info, text="Welcome to upload info menu.", bg="yellow", font=("calibri", 20)).pack()
...
def seller_menu():
    ...
    Button(seller_menu, text="Upload Info", font=("calibri", 20), width=20, height=1, bg="yellow", relief="solid", command=upload_info).pack(pady=5)
...
def login():
    ...
    Button(login_screen, text="Login", font=("calibri", 20), width=20, height=1, bg="yellow", relief="solid", command=login_to_seller_or_admin).pack()
